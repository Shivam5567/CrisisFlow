...
import { X, MapPin, Clock, Package, Utensils, Heart, Home, AlertCircle, User } from 'lucide-react'
...
export default function AddResourceModal({ onClose, onSuccess, userLocation }) {
  ...
  return (
    <div style={{
      ...
      <div className="glass animate-fade-up" style={{ width: '100%', maxWidth: 480, padding: 28 }}>
        {/* Header */}
        ...
        <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div>
            ...
            <textarea className="input" rows={2} value={form.description}
              ...
              placeholder="Hot meals for 20 people, dietary restrictions noted…" />
          </div>
